...
DIGEST = {'academic_today': [{'authors': 'Nakamura, Ellis',
 ...
 'top_stories': [{'body': 'The currency strengthened *3.5 percent* on the week as '
                 ...
                 {'body': 'The second passage this week, tracked by the Joint '
                          'Staff from *0400* local.',
                  'category_tag': 'Defense',
                  'headline': 'Chinese destroyer transits the Miyako Strait',
                  'source': 'Kyodo',
                  'src_line': 'per Kyodo',
                  'url': 'https://example.org/2b'},
                 {'body': 'METI named the recipients of the third tranche, '
                          'worth **420 billion yen**.',
                  'category_tag': 'Technology',
                  'headline': 'Chip subsidy tranche released',
                  'source': 'Nikkei Asia',
                  'src_line': 'per Nikkei Asia',
                  'url': 'https://example.org/2c'},
                 {'body': 'Budget testimony is scheduled for Thursday before '
                          'the upper house committee.',
                  'category_tag': 'Politics-Diet',
                  'headline': 'Upper house committee sets hearing',
                  'source': 'NHK World',
                  'src_line': 'per NHK World',
                  'url': 'https://example.org/2d'}],
